...
class HBAbstractBannerAdViewController: UIViewController {
    ...
    func showAds(isWithStatusBar flag: Bool) {
        _ = (flag == true) ? UIApplication.shared.statusBarFrame.height as CGFloat : 0.0 as CGFloat
        // 広告
        ...
        bannerViewFooter = GADBannerView(adSize: kGADAdSizeBanner, origin: CGPoint(x: leftMargin, y: self.view.frame.maxY - kGADAdSizeBanner.size.height))
